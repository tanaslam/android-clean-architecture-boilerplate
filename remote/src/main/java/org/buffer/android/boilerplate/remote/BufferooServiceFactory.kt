...
object BufferooServiceFactory {
    ...
    fun createBuffeoorService(isDebug: Boolean): BufferooService {
        val okHttpClient = createOkHttpClient(
                createLoggingInterceptor(isDebug))
        return createBufferooService(okHttpClient, createGson())
    }

    private fun createBufferooService(okHttpClient: OkHttpClient, gson: Gson): BufferooService {
